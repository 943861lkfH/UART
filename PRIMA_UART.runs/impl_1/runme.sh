...
HD_PWD='M:/2010/Vivado_2_kurs_schem/IVBO-01/Khomyakova/PLIS_UART/PLIS_UART.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DEVICE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DEVICE.tcl -notrace
